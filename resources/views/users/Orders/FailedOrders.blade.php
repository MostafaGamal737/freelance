...
@section('body')
  ...
  <div class="image-container">
              <img src="{{asset('images/wfh.png')}}" style="width:100%" class="img-fluid" alt="Responsive image">
                 <h1 class="centered" id="failed-deal-txt">المعاملات الفاشله</h1>
                                  ...
                                  <div class="row media-body">
                                      <div class="container">
                                          <div class="row flex-column-reverse flex-md-row mt-3">
                                            ...
                                            <div class="col-sm ">
                                              <p class="mt-0" id="failed-deal-txt">{{$order->job_name}}</p>
                                            </div>

                                            <div class="col-sm " >
                                              <p class="mt-0" id="failed-deal-txt">{{$order->invoice->price}} ريال</p>
                                            </div>

                                            <div class="col-sm">
                                              <h5 class="mt-0"id="failed-deal-txt">{{$order->invoice->provider_name}}</h5>
                                            </div>
